...
/** @brief Reads next state on the given memory location
 *
...
/** @brief Returns pointer to the beginning of state array.
 *
 *Check if the filter structure is empty. If not, return StateIndex=0
 *  @param iir filter structure
 */
